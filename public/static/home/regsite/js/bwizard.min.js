...
(function (a, b) {
    a.widget("bootstrap.bwizard", {
        ...
        _createButtons: function () {
            ...
            if (!this.buttons) {
                ...
                if (c != "") {
                    ...
                    this.backBtn = a("<li class='previous shangyibu'><a href='#'>" + c + "</a></li>").appendTo(this.buttons).bind({
                        click: function () {
                            e.back();
                            return false;
                        }
                ...
                if (g != "") {
                    ...
                    this.nextBtn = a("<li class='next xiayibu xiayibugai' ><a href='#'>" + g + "</a>").appendTo(this.buttons).bind({
                        click: function () {
                            e.next();
                            return false;
                        }
                    }).attr("role", "button");
                    a("<li class='next wancheng' style='display:none'><a style='cursor:pointer;'>" + cp + "</a></li>").appendTo(this.buttons);
                    var f = true;
                }
                if (f) {
        ...
        add: function (d, g) {
            ...
            var c = this,
                f = this.options,
                e = a(f.panelTemplate || c._defaults.panelTemplate).data("destroy.bwizard", true),
                h;
        ...
        show: function (f) {
            ...
            var d = this,
                h = this.options,
                e = a.extend({}, this._ui(this.panels[h.activeIndex])),
                c, g;
            e.nextIndex = f;
        ...
        load: function (e) {
            var c = this,
                h = this.options,
                f = this.panels.eq(e)[0],
                d = a.data(f, "load.bwizard"),
                g;
            this.abort();
