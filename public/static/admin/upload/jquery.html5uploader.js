            ...
            var ZXXFILE = {
                ...
                onSelect: option.onSelect||function(files){
                    ...
                    for(var i=0;i<files.length;i++){
                        ...
                        //判断是否是自动上传
                        if(option.auto){
                             // console.log($(".uploadfile")[0].files[0]);//可以查看全部 数组列
                            // var name = $(".uploadfile")[0].files[0];
                            // var name = new FormData($(".uploadfile")[0]);

                            // var word = $(".uploadfile")[0].files[0];
                            ...
                            // let files = Array.from($(".uploadfile")[0].files[0]).map(x => x.name);
