<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\phpStudy\WWW\xlz\public/../application/home\view\index\index.html";i:1545896130;}*/ ?>
<!DOCTYPE html>
<html lang="en">
				...
				<div class="row">
					...
					<aside class="col-md-4 blog-aside">
							<div class="aside-widget">
								...
								<div class="body">
									<ul class="clean-list">
										<?php if(is_array($greatpeople) || $greatpeople instanceof \think\Collection || $greatpeople instanceof \think\Paginator): if( count($greatpeople)==0 ) : echo "" ;else: foreach($greatpeople as $key=>$greatpeople): ?>
										<li>
										<img src="__STATIC__../..<?php echo $greatpeople['photo']; ?>" style="width:50px"/>
										<a href="<?php echo url('volunt',['id'=>$greatpeople['sid']]); ?>"><?php echo $greatpeople['name']; ?></a> &nbsp;&nbsp;	
										 <?php echo $greatpeople['theme']; ?>	
										</li>	
										<?php endforeach; endif; else: echo "" ;endif; ?>
									</ul>
								</div>
