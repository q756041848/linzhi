<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\phpStudy\WWW\xlz\public/../application/home\view\index\volunt.html";i:1545896130;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
            ...
            <div class="row">
                <div class="col-md-8 blog-main">
                    <article class="blog-post">
                        ...
                        <div class="body">
                                <h2><?php echo $voluntlist['theme']; ?></h2>
                                <div class="meta">
                                        <i class="fa fa-user"></i> <?php echo $voluntlist['name']; ?> <i class="fa fa-calendar"></i><?php echo date('Y-m-d H:i:s',$voluntlist['issue_time']); ?><span class="data"><a
                                                href="#comments"></a></span>
                                                院系：<?php echo $voluntlist['unit']; ?>
                                    </div>
                                    <p>
                                        <?php echo htmlspecialchars_decode($voluntlist['content']); ?>
                                    </p>
                        </div>
                    </article>
                </div>
                <aside class="col-md-4 blog-aside">
                    <div class="aside-widget">
                        ...
                        <div class="body scroller">
                            <ul class="clean-list">
                               <?php if(is_array($voluntlist2) || $voluntlist2 instanceof \think\Collection || $voluntlist2 instanceof \think\Paginator): if( count($voluntlist2)==0 ) : echo "" ;else: foreach($voluntlist2 as $key=>$voluntlist2): ?>
                               <li>
                                    <img src="__STATIC__../..<?php echo $voluntlist2['photo']; ?>"  style="width:50px" />
                                    <a href="<?php echo url('volunt',['id'=>$voluntlist2['sid']]); ?>"><?php echo $voluntlist2['name']; ?></a> &nbsp;&nbsp;	
                                     <?php echo $voluntlist2['theme']; ?>	
                                    </li>	
