<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"D:\phpStudy\WWW\xlz\public/../application/admin\view\pactivity\applications.html";i:1545878570;s:71:"D:\phpStudy\WWW\xlz\public/../application/admin\view\template\base.html";i:1545717426;s:82:"D:\phpStudy\WWW\xlz\public/../application/admin\view\template\javascript_vars.html";i:1545717426;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="panel panel-default"  style="margin-top: 40px;border: none;">
    <div class="panel-body">
        ...
        <?php if($states == 1): ?>
        <ul class="list-group">
            <kbd>已招募：<?php echo $countnum; ?>/<?php echo $num; ?></kbd>
            <!--循环遍历-->
            ...
            <li class="list-group-item">
                ...
                <?php else: ?>
                    <span style="float: right;">
                        <button class="btn btn-default" onclick="status(1,<?php echo $li['id']; ?>,'通过',<?php echo $li['aid']; ?>,<?php echo $li['sid']; ?>)">通过</button>
                        <button class="btn btn-danger" onclick="status(2,<?php echo $li['id']; ?>,'退回',<?php echo $li['aid']; ?>,<?php echo $li['sid']; ?>)">退回</button>
                    </span>
                <?php endif; endif; ?>
                <!--按钮分割线-->
                <ul id="xinxi">
                    ...
                    <li style="width: 250px">申请日期：<?php echo date('Y-m-d h:i:s',$li['filingdate']); ?></li>
                </ul>
                <br>
                <br>
            </li>
    ...
    function status(val,val2,val3,val4,val5) {
        if (val==2){
            ...
            layer.prompt({title: '退回原因[可以不填]', formType: 2}, function(pass, index){
                layer.close(index);
                $.ajax({
                    'url':'<?php echo url("Pactivity/status"); ?>',
                    'type':'post',
