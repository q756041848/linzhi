<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"D:\phpStudy\WWW\xlz\public/../application/admin\view\index\index.html";i:1545717424;s:82:"D:\phpStudy\WWW\xlz\public/../application/admin\view\template\javascript_vars.html";i:1545717426;s:75:"D:\phpStudy\WWW\xlz\public/../application/admin\view\template\nav_left.html";i:1545717426;s:75:"D:\phpStudy\WWW\xlz\public/../application/admin\view\template\nav_menu.html";i:1545717426;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    function logout() {
        layer.confirm('您确定要退出登录？',{title:'退出提醒'},function (index) {
            layer.msg('退出成功');
            location.href = '<?php echo \think\Url::build("Pub/logout"); ?>'
        })
    }
    function clearCache() {
        layer.confirm('您确定要清除缓存吗？',{title:'清除提醒'},function (index) {
            layer.msg('清除缓存成功');
            location.href = '<?php echo \think\Url::build("Pub/clearCache"); ?>'
        })
    }
</script>
</body>
