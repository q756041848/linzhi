<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\phpStudy\WWW\xlz\public/../application/admin\view\admin_user\modal_upload_img.html";i:1545717424;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="__STATIC__/css/cropper.css">
    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="img-container">
                <img id="image" src="__STATIC__/images/picture.jpg" alt="Picture">
            </div>
        </div>
        <div class="col-md-3">
            <!-- <h3>Preview:</h3> -->
...
<script src="__STATIC__/js/cropper.js"></script>
...
<script>
    $('#wonderful').click(function () {
        ...
        //console.log($("#form1"));
        $.ajax({
            url:"<?php echo url('AdminUser/upimg'); ?>",
            type:'post',
            data:data,
            cache: false,
            processData: false,
