<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"F:\phpStudy\WWW\lz\public/../application/admin\view\pactivity\index.html";i:1545745134;s:70:"F:\phpStudy\WWW\lz\public/../application/admin\view\template\base.html";i:1545717590;s:81:"F:\phpStudy\WWW\lz\public/../application/admin\view\template\javascript_vars.html";i:1545717590;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container" style="margin-top: 50px;">
    <div class="cl pd-5 bg-1 bk-gray">
        <?php if($quanxian == 2): ?>
        <a class="btn btn-primary radius mr-5" style="float: left" href="javascript:;" onclick="layer_open('添加活动','/admin/pactivity/edit.html','780px','580px')"><i class="Hui-iconfont"></i> 添加</a>
        <?php endif; ?>
