...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input id="photos" type="text" name="photo" class="input-text" value="<?php echo isset($vo['photo']) ? $vo['photo'] :  ''; ?>" /><img style="height: 50px;height: 50px;" id="photoimg" src="<?php echo isset($vo['photo']) ? $vo['photo'] :  ''; ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                    <select  name="coll" class="input-text" datatype="*" nullmsg="请选择所属分类">
                            <option>请选择</option>
                            
                            <?php if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): if( count($info)==0 ) : echo "" ;else: foreach($info as $key=>$cat): ?>
                            <option <?php if(!empty($vo['coll'])): if($cat['id'] == $vo['coll']): ?> selected <?php endif; else: endif; ?> value="<?php echo $cat['id']; ?>"><?php echo $cat['catname']; ?></option>
